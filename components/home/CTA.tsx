  ...
  return (
    <div className="pt-36 relative w-full">
      ...
      <div className="pt-14 pb-40">
       ...
       <a
        href="https://mail.google.com/mail/?view=cm&fs=1&to=mrunalforblockchain@gmail.com"
        target="_blank"
        rel="noopener noreferrer"
        className="cursor-pointer font-bold whitespace-nowrap 
                  mt-6 px-8 py-3 text-white border-2 rounded-full 
                  border-white bg-bg hover:bg-fun-pink hover:border-fun-pink 
                  transition-colors"
      >
        Get in Touch
      </a>
